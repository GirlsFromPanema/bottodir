    ...
    try {
        ...
        if (
            ...
            return interaction.reply({
                content: "I cannot warn this user as their highest role is higher than mine or I have the same highest role as them.",
                ephemeral: true,
            });
        ...
        // Only allow the interaction author to use the interaction
        const filter = (i) => {
            if (i.user.id === interaction.user.id) return true;
            else i.reply({ content: `${emojis.error} | This is not for you!`, ephemeral: true });
        };
